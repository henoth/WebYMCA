...
namespace WebYMCA.Controllers
{
    public class YMCAsController : Controller
    {
        ...
        {
            return View(await _context.YMCA.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Dane,Waga,Wzrost,Man")] YMCA yMCA)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Dane,Waga,Wzrost,Man")] YMCA yMCA)
        {
            if (id != yMCA.Id)
            {
                return NotFound();
